...
#alias gemsync='rsync --recursive --update --delete --human-readable --progress /home/loki/sync/gemini low-key:/home/loki/low-key.me/'
#alias helios-backup='restic -r /media/seagate/restic-helios backup --files-from-verbatim=/home/loki/.restic-inclusions --exclude-file=/home/loki/.restic-exclusions'
#alias helios-backup-b2='restic -r s3:sgp1.digitaloceanspaces.com/low-key/helios backup --files-from-verbatim=/home/loki/.restic-inclusions --exclude-file=/home/loki/.restic-exclusions'
#alias violet-backup='aft-mtp-mount /home/loki/violet && restic -r /media/seagate/restic-violet backup --files-from-verbatim=/home/loki/.restic-violet-inclusions && fusermount -u /home/loki/violet'
